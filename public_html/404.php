...
<head>
    ...
    <meta name="description" content="Read about Set One's Cap and the member of the band">
    ...
    <header>
        <nav id="menu" class="fg-black bg-white fixed">
            ...
            <ul class="float-right">
                <li><a href='/'>Home</a></li><li><a href='/concerts/'>Concerts</a></li><li><a href='/photos/'>Photos</a></li><li><a href='/videos/'>Videos</a></li><li><a href='/about/'>About</a></li>            </ul>

        </nav>
    </header>
    <section class="col-12 fg-black header fourohfour" data-speed="1.4" data-type="background">
...
<div class="col-12 bg-white fg-black">
    <div class="col-8" id='introduction'>
        ...
        <p>If you were directed here from a link, please let us know by sending a email to <a href="mailto:post@setonescap.com?Subject=404%20Error" target="_top">post@setonescap.com</a></p>
    </div>
    <div class="col-4 text-center">
        <img src="/images/template/logo-big.png" alt="Set Ones Cap logo, drawing of a bird with a hat"/>
    </div>
</div>    </main>
    ...
    <footer class="fixed-bottom bg-white fg-black">
        ...
        <div class="col-6 text-right">
            Website by: <a href="https://plus.google.com/+BenjaminDehli1/" rel="publisher" target="_blank">Benjamin Dehli</a>
        </div>
    </footer>
